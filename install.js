...
// Progressive enhancement: installation support must never be required for practice.
(function () {
  ...
  function showIOSInstructions() {
    ...
    try {
      ...
      // A browser without dialog support simply leaves the rest of ConjuFlow usable.
    }
  }
  ...
  window.addEventListener("beforeinstallprompt", event => {
    // Android phones and tablets expose this event; desktop browsers do not get a custom control.
  ...
  installButton.addEventListener("click", async () => {
    ...
    try {
      ...
      // Cancellation or an unavailable prompt is non-fatal and needs no retry loop.
    } finally {
